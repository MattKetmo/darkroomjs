...
;(function(window, document, fabric) {
  ...
  Darkroom.prototype = {
    ...
    replaceImage: function(newFabricImage, changedEvent) {
      ...
      var height = Math.min(Math.max(options.minHeight, newFabricImage.getHeight()), options.maxHeight),
          width  = Math.min(Math.max(options.minWidth, newFabricImage.getWidth()), options.maxWidth);
