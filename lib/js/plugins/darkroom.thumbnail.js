;(function(Darkroom, fabric, document) {
  ...
  Darkroom.plugins['thumbnail'] = Darkroom.Plugin.extend({
    ...
    initialize: function() {
      ...
      buttons.addThumbnail.addEventListener('click', implementation.eventListeners.addThumbnail);
      ...
      inputs.thumbnails.addEventListener('change', implementation.eventListeners.selectThumbnail);
