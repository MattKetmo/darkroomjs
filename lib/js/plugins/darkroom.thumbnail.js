;(function(Darkroom, fabric, document) {
  ...
  var helpers = {
    ...
    hideElement: function(element) { element.setAttribute('style', 'display: none;'); },

    showElement: function(element) { element.removeAttribute('style'); }
  };
  ...
  Darkroom.plugins['thumbnail'] = Darkroom.Plugin.extend({
    ...
    initialize: function() {
      ...
      inputs.scale = helpers.createElement('input', {
        placeholder: 'Scale',
        title:       'Scale',
        type:        'number',
        step:        0.5,
