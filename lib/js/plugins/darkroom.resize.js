;(function(window, document, Darkroom) {
  ...
  var states = {
    resizeNotClicked: function() {
      ...
      buttons.resize
        .removeEventListener('click', actions.resizeClicked.click)
        .addEventListener('click', actions.resizeNotClicked.click);
    ...
    resizeClicked: function() {
      ...
      buttons.resize
        .removeEventListener('click', actions.resizeNotClicked.click)
        .addEventListener('click', actions.resizeClicked.click);
    }
  };
  ...
  Darkroom.plugins['resize'] = Darkroom.Plugin.extend({
    ...
    initialize: function initDarkroomResizePlugin() {
      ...
      imageProps.original = {
        ...
        lockMovementX:        image.get('lockMovementX'),
        lockMovementY:        image.get('lockMovementY'),
