;(function(window, document, Darkroom, fabric) {
  ...
  Darkroom.plugins['crop'] = Darkroom.Plugin.extend({
    ...
    cropCurrentZone: function() {
      ...
      var ratio = this.darkroom.imageSource.getWidth() / canvas.getWidth();
      var totalOnLoad = 0;
      ...
      imageSource.onload = function() {
        ...
        var imgSourceInstance = new fabric.Image(this, {
          // options to make the image static
          selectable: false,
          evented: false,
          lockMovementX: true,
        ...
        // Add image
        _this.darkroom.imageSource = imgSourceInstance;
      ...
      imageSource.src = this.darkroom.imageSource.toDataURL({
        left: this.cropZone.getLeft() * ratio,
        top: this.cropZone.getTop() * ratio,
        width: this.cropZone.getWidth() * ratio,
        height: this.cropZone.getHeight() * ratio
      });
