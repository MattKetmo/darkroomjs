;(function(window, document, Darkroom, fabric) {
  ...
  Darkroom.plugins['crop'] = Darkroom.Plugin.extend({
    ...
    onMouseMove: function(event) {
      if(this.keyCroping) return this.onMouseMoveKeyCrop(event);
    ...
    onMouseMoveKeyCrop: function(event) {
      ...
      if(!this.cropZone.left || !this.cropZone.top) {
        this.cropZone.setTop(y);
        this.cropZone.setLeft(x);
      }

      this._renderCropZone(
        Math.min(this.cropZone.left, x),
        Math.min(this.cropZone.top, y),
        Math.max(this.cropZone.left+this.cropZone.width, x),
        Math.max(this.cropZone.top+this.cropZone.height, y)
      );
    },
    ...
    onKeyDown: function(event) {
      if(event.keyCode != this.options.cropKey || this.keyCroping) return;
      this.keyCroping = true ;
